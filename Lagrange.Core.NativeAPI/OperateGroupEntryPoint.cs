...
namespace Lagrange.Core.NativeAPI
{
    public static class OperateGroupEntryPoint
    {
        ...
        public static IntPtr FetchGroupNotifications(int index, ulong count, ulong start )
        {
        ...
        public static IntPtr FetchFilteredGroupNotifications(int index, ulong count, ulong start )
        {
            if (Program.Contexts.Count <= index)
            {
                return IntPtr.Zero;
        ...
        public static IntPtr GetGroupList(int index, bool refresh )
        {
            if (Program.Contexts.Count <= index)
            {
                return IntPtr.Zero;
        ...
        public static IntPtr GetMemberList(int index, long groupUin, bool refresh )
        {
            if (Program.Contexts.Count <= index)
            {
                return IntPtr.Zero;
