                ...
                switch (message.Entities[i])
                {
                    ...
                    case GroupFileEntity groupFileEntity:
                        entities[i] = new TypedEntityStruct()
                        {
                            ...
                            Entity = Marshal.AllocHGlobal(Marshal.SizeOf<GroupFileEntityStruct>())
                        };
                    ...
                    case FileEntity fileEntity:
                        entities[i] = new TypedEntityStruct()
                        {
                            Type = (int)EntityType.FileEntity,
                            Entity = Marshal.AllocHGlobal(Marshal.SizeOf<FileEntityStruct>())
                        };
                        Marshal.StructureToPtr((FileEntityStruct)fileEntity, entities[i].Entity, false);
                        break;
                }
            }
