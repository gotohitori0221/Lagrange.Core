...
[ApiHandler("reject_group_request")]
public sealed class RejectGroupRequestHandler(BotContext lagrange) : INoResultApiHandler<RejectGroupRequestHandler.Request>
{
    ...
    public sealed class Request(long notificationSeq, string notificationType, long groupId, string? reason, bool isFiltered = false)
    {
        ...
        [JsonPropertyName("reason")] public string? Reason { get; init; } = reason;
