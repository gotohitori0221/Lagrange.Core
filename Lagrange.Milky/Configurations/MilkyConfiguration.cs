...
public class MilkyConfiguration(MilkyHttpServerConfiguration httpServer, string? accessToken = null, MilkyApiConfiguration? api = null, MilkyEventConfiguration? event_ = null, MilkyMessageConfiguration? message = null)
{
    ...
    public MilkyMessageConfiguration Message { get; } = message ?? new();
}

public class MilkyMessageConfiguration(bool ignoreSelf = false)
{
