...
{
    [LoggerMessage(LogLevel.Information, "The SSE event server is started at {Host}:{Port}")]
    public static partial void LogServerStarted(this ILogger<SSEEventHandler> logger, string host, ushort port);
    ...
    public static partial void LogConnect(this ILogger<SSEEventHandler> logger, Guid id);
    ...
    public static partial void LogDisconnect(this ILogger<SSEEventHandler> logger, Guid id);
