...
The project [Lagrange.Milky](https://github.com/LagrangeDev/LagrangeV2/tree/main/Lagrange.Milky) implements [Milky](https://milky.ntqqrev.org/) protocol (v1.3 compatible). You can use it to provide web service to bot applications like NoneBot.

It features:
- Complete support for HTTP API, SSE, WebSocket and WebHook.
- Full implementation of all Milky APIs, Event types, and Incoming/Outgoing message segments.
- Dynamic protocol fingerprint alignment with sign server via `appinfo_v2`.

Check [Lagrange.Milky README](https://github.com/LagrangeDev/LagrangeV2/tree/main/Lagrange.Milky#readme) for the full feature list and implementation details.
