...
internal class GroupFSRenameFileEventReq(long groupUin, string fileId, string parentFolderId, string newFileName) : ProtocolEvent
{
    public long GroupUin { get; } = groupUin;
...
internal class GroupFSRenameFileEventResp : ProtocolEvent
{
    public static readonly GroupFSRenameFileEventResp Default = new();
}

internal class GroupFSPersistEventReq(long groupUin, string fileId) : ProtocolEvent
{
    public long GroupUin { get; } = groupUin;
...
internal class GroupFSPersistEventResp : ProtocolEvent;
