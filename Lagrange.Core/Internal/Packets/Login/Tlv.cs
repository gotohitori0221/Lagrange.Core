...
internal ref struct Tlv : IDisposable
{
    ...
    public void Tlv124Android()
    {
        ...
        _writer.Write("13", Prefix.Int16 | Prefix.LengthOnly); 
        _writer.Write<short>(0x02); 
        _writer.Write("", Prefix.Int16 | Prefix.LengthOnly); 
        _writer.Write("wifi", Prefix.Int32 | Prefix.LengthOnly); 
    ...
    public void Tlv128()
    {
        ...
        _writer.Write(ReadOnlySpan<char>.Empty, Prefix.Int16 | Prefix.LengthOnly); 
    ...
    public void Tlv187()
    {
        ...
        _writer.Write(MD5.HashData([0x02, 0x00, 0x00, 0x00, 0x00, 0x00])); 
