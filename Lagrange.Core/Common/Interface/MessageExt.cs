...
public static class MessageExt
{
    ...
    public static Task<List<BotMessage>> GetForwardedMessages(this BotContext context, string resId, bool isGroup)
        => context.EventContext.GetLogic<MessagingLogic>().GetForwardedMessages(resId, isGroup);

    public static Task<(ulong Sequence, long Time, string FileId)> SendFriendFile(this BotContext context, long targetUin, Stream fileStream, string? fileName = null)
    ...
    public static Task GroupFSMove(this BotContext context, long groupUin, string fileId, string targetDirectory, string parentDirectory)
        => context.EventContext.GetLogic<OperationLogic>().GroupFSMove(groupUin, fileId, parentDirectory, targetDirectory);

    public static Task<string> GroupFSCreateFolder(this BotContext context, long groupUin, string name, string parentFolderId = "/")
    ...
    public static Task GroupFSPersist(this BotContext context, long groupUin, string fileId)
        => context.EventContext.GetLogic<OperationLogic>().GroupFSPersist(groupUin, fileId);
